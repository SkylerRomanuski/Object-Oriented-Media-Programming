...
void makeglobePShape() {
  ...
  //link for image https://knowyourmeme.com/memes/lebron-james-you-are-my-sunshine-edits
  //edited by me to make it look better in 3D
  globePImage = loadImage("lebonbon.jpg");
...
class Globey implements Avatar {
  ...
  void display() {
    ...
    if(mowCounter > 0){
      scale(mowScaleXYZ);
      mowScaleXYZ -= .003; //makes the globy's dissapear slowly
    }
  ...
  //}
  void mow() {
    mowCounter ++; //add 1 to mowCounter
  }
}
